...
<cfset this.prefix = "spreadsheet,get,array,struct,system,nx,bit,binary,cache,collection,create,date,file,find,html,ip,image,is,list,ls,query,set,jmx,java,to,xml,replace,span,sqs,thread,url,write,yes,amazon,directory,delete,salesforce">
